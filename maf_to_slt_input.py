...
COLUMN_ALIASES = {
    ...
    "gnomAD_AN": ["gnomAD_AN", "gnomAD_exome_AN", "gnomAD_genome_AN",
                   "gnomad_AN", "gnomad_exome_AN"],
    "gnomAD_state": ["gnomAD_state", "gnomad_state"],
    "gnomAD_callable": ["gnomAD_callable", "gnomad_callable"],
    "gnomAD_evaluable": ["gnomAD_evaluable", "gnomad_evaluable"],
